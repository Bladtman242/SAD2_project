...
\texttt{Algorithmic Techniques for Processing Data Streams}\citep{ikonomovskazelke}:
...
As stated in
\sloppy{\texttt{Algorithmic Techniques for Processing Data Streams}\citep{ikonomovskazelke}: 
...
%As described in \texttt{Algorithmic Techniques for Processing Data Streams}\citep{ikonomovskazelke}: we can adjust the quality of
...
containing the top $l<k$ movies increases. \texttt{Efficient Computation of Frequent and Top-k Elements in Data Streams}\citep{efficientstreams}: present an
...
Metwally et. al.
The \textit{space-saving} algorithm presented in \texttt{Efficient Computation of Frequent and Top-k Elements in Data Streams}\citep{efficientstreams}: works
as follows:
...
\texttt{Efficient Computation of Frequent and Top-k Elements in Data Streams}\citep{efficientstreams} Proves several theorems that are important for our use
